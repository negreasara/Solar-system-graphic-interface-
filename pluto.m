figure(1);
title("PLUTO 3D VIEW", 'Color', 'white'); % Set title text color to white
fig = figure('Color', 'black'); % Set figure background to black

img = imread('pluto_colormap.jpg'); % Load texture for Mercury
